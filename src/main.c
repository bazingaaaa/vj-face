...
int main(int argc, char *argv[])
{
	...
	// Model *model = load_model("./backup/attentional_cascade_10.cfg");
	// model = attentional_cascade(model, t_pos_data, v_pos_data, t_neg_data, v_neg_data, 24, FPR_GOAL, 0.5, 0.005);
	// printf("Training end...\n");
